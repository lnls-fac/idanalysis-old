...
def plot_pole_analysis():
    pole_length, beff, _ = readfile('ivu_shangai_op3/pole_file.txt')
...
def plot_gap_analysis():
    gap, beff, bpeak = readfile('ivu_shangai_op3/gap_file.txt')
...
def plot_roff_analysis():
    xpos, beff, _ = readfile('ivu_shangai_op3/roll-off_file.txt')
