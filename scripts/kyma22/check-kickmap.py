...
def plot_kick_at_plane(posy, kick_plane='X', meas_flag=True):
    """."""
...
def plot_kick_all_planes(meas_flag=True):
    """."""
    fname = utils.get_kmap_filename()
...
if __name__ == '__main__':
    meas_flag = True
    plot_kick_at_plane(
        posy=0, kick_plane='y', meas_flag=meas_flag)
    plot_kick_all_planes(meas_flag=meas_flag)
